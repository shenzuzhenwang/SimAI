...
public:
    ...
    Ring(ComType type, int id, int layer_num, RingTopology *ring_topology, uint64_t data_size, RingTopology::Direction direction,
    ...
    public:
        ...
        inline void ExitSection() { g_ring_inCriticalSection.store(false, std::memory_order_release); }
